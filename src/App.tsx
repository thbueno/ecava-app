                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                      Transforme sua paixão pelo vinho em uma experiência extraordinária. 
                      Baixe agora e descubra por que somos a escolha de especialistas.
                    </p>
                  </div>
            ...
            <div className="grid lg:grid-cols-12 gap-12">
              ...
              <div className="lg:col-span-4 space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-2xl font-black text-gradient">ECAVA</span>
                    <span className="text-xs text-muted-foreground tracking-widest">LACAVA</span>
                  </div>
                </div>
                
                <p className="text-muted-foreground leading-relaxed max-w-sm">
                  Transformando paixão por vinho em experiência inteligente. 
                  A solução mais sofisticada para gestão de adegas do mundo.
                </p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-1 text-brand-gold">
                    {[1, 2, 3, 4, 5].map((i) => (
                      <div key={i} className="w-4 h-4 text-brand-gold fill-current">★</div>
                    ))}
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                <div className="space-y-3">
                  {['Recursos', 'Preços', 'API', 'Integrações', 'Suporte'].map((item) => (
                    <a key={item} href="#" className="block text-sm text-muted-foreground hover:text-brand-primary transition-colors">
                      {item}
                    </a>
                  ))}
                </div>
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                <div className="space-y-3">
                  {['Sobre', 'Blog', 'Carreira', 'Imprensa', 'Parceiros'].map((item) => (
                    <a key={item} href="#" className="block text-sm text-muted-foreground hover:text-brand-primary transition-colors">
                      {item}
                    </a>
                  ))}
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                <div className="space-y-3">
                  {['Documentação', 'Guias', 'Webinars', 'Status', 'Segurança'].map((item) => (
                    <a key={item} href="#" className="block text-sm text-muted-foreground hover:text-brand-primary transition-colors">
                      {item}
                    </a>
                  ))}
            ...
            <div className="border-t border-border/50 mt-16 pt-8">
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <div className="text-sm text-muted-foreground">
                  <span>&copy; 2024 Ecava. Todos os direitos reservados.</span>
                </div>
